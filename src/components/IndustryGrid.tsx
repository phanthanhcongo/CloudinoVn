...
export default function IndustryGrid() {
  return (
    <section className="relative overflow-hidden lg:overflow-visible bg-black py-16 sm:py-24 lg:py-[130px]">
      <img
      ...
      <div className="relative mx-auto max-w-[1920px] px-3 sm:px-8 md:px-16 xl:px-[285px] flex items-center justify-center">
        <div className="relative flex items-center justify-center h-[340px] min-[420px]:h-[420px] sm:h-[540px] lg:h-[724px] w-full overflow-visible">
          <div className="relative h-[724px] w-[724px] shrink-0 scale-[0.44] min-[420px]:scale-[0.56] sm:scale-[0.74] lg:scale-100 origin-center transition-transform duration-300">
