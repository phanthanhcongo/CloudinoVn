...
const industries: Array<{ name: string; x: number; y: number }> = [
...
export default function IndustryGrid() {
  return (
    <section className="relative overflow-hidden lg:overflow-visible bg-black py-10 sm:py-16 lg:py-20 xl:py-24 2xl:py-[100px]">
      <img
      ...
      <div className="relative mx-auto max-w-[1920px] px-3 sm:px-8 md:px-10 lg:px-12 xl:px-16 2xl:px-[285px] flex items-center justify-center">
        <div className="relative flex items-center justify-center h-[280px] min-[375px]:h-[320px] min-[420px]:h-[400px] sm:h-[500px] lg:h-[480px] xl:h-[540px] 2xl:h-[620px] w-full overflow-visible">
          <div className="relative h-[724px] w-[724px] shrink-0 scale-[0.36] min-[375px]:scale-[0.42] min-[420px]:scale-[0.52] sm:scale-[0.68] lg:scale-[0.65] xl:scale-[0.72] 2xl:scale-[0.85] origin-center transition-transform duration-300">
